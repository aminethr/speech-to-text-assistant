...
class _SpeechToTextPageState extends State<SpeechToTextPage> {
  ...
  Future<http.Response> sendTextToServer(String text) async {
    ...
    final url = Uri.parse('http://192.168.105.34:8000/Model%20Answer/');
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: PreferredSize(
        preferredSize: Size.fromHeight(screenWidth * 0.045),
        child: AppBar(
         ...
         // elevation: 0.0, // Add some elevation
          title: Text('Recording Page', style: TextStyle(    fontSize: screenWidth * 0.056,
          ...
          Center(
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: screenWidth * 0.127), // Increased space
                ElevatedButton(
                  onPressed: _isListening ? stopListening : startListening,
                  style: ElevatedButton.styleFrom(
                    primary: Colors.black,
                    onPrimary: Colors.white,
                    minimumSize: Size(screenWidth * 0.5, screenWidth * 0.152),
                    shape: RoundedRectangleBorder(
